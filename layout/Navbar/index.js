      ...
      <div className={styles['nav-content']}>
        <div className={styles['logo-container']}>
          <a href="/" className={styles['logo-link']}>
            <svg viewBox="0 0 64 36" xmlns="http://www.w3.org/2000/svg" className={styles['logo-svg']}>
        ...
        <div className={styles['nav-links']}>
          ...
          <div className={styles['language-selector']}>
            <button>
              <img src="https://hatscripts.github.io/circle-flags/flags/gb.svg" alt="English" />
              <span>EN</span>
            </button>
          </div>
          <a href="/auth/sign-in" className={styles['get-started']}>Get started →</a>
        </div>
      </div>
    </nav>
  )
